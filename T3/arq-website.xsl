...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <xsl:result-document href="arq-site/index.html">
            <html>
                <head>
    ...
    <xsl:template match="ARQELEM" mode="conteudo">
        <xsl:result-document href="arq-site/{generate-id()}.html">
            <html>
                <head>
                    <title>
                        <xsl:value-of select="IDENTI"/>
                ...
                <body>
                    ...
                    <address>
                        [<a href="index.html#indice{generate-id()}">Voltar à Home</a>]
                    </address>
