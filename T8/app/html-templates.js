          ...
          <body>
              ...
              <div class="w3-container w3-teal">
                ...
                <form action="/files/upload">
                    <input class="w3-btn w3-blue-grey" style="width: 100%" type="submit" value="Upload Files" />
                </form>
...
function fileForm( d ){
    ...
    <html>
        ...
        <body>
            ...
            <form id="form" class="w3-container" action="/files" method="POST" enctype="multipart/form-data">
            <div>
                ...
                <button id="add" class="w3-btn w3-blue-grey" onclick="myFunction(); return false;">Add file</button>
                <input class="w3-btn w3-blue-grey" type="submit" value="Submit"/>

                <form action="/">
                    <input type="submit" class="w3-btn w3-blue-grey" style="float:right" value="Go back" />
                </form>
